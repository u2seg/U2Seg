...
if __name__ == "__main__":
    ...
    #         COCO_CATEGORIES,
    #     )
    separate_coco_semantic_from_panoptic('datasets/prepare_ours/u2seg_annotations/panoptic_annotations/coco{}_{}.json'.format(split, cluster_num),
                                         'datasets/prepare_ours/u2seg_annotations/panoptic_annotations/coco{}_{}'.format(split, cluster_num),
                                         'datasets/prepare_ours/u2seg_annotations/panoptic_annotations/panoptic_stuff_coco{}_{}'.format(split, cluster_num),
                                         COCO_CATEGORIES
                                         )
