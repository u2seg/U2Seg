...
class COCOEvaluator(DatasetEvaluator):
    ...
    def do_hangarain_mapping(self, num_cls, coco_results, save_path):
        ...
        for _result in coco_results:
            ...
            gt_anns_bbox = []
            for _ann in gt_anns:
                gt_anns_bbox.append(_ann['bbox'])
            iscrowd = [0 for i in range(len(gt_anns))]
            # compute the iou
    ...
    def _eval_predictions(self, predictions, img_ids=None):
        ...
        if hasattr(self._metadata, "thing_dataset_id_to_contiguous_id"):
            ...
            for result in coco_results:
                ...
                category_id_matched = mapping_dict[category_id]
                if category_id_matched == -1:
                    continue
                else:
                    result["category_id"] = reverse_id_mapping[category_id_matched]
                    new_results.append(result)
        coco_results = new_results
