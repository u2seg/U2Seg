...
def train_memory_imagenet(transform_name, batch_size=128, workers=2, with_val=False, transform_override=None):
    ...
    assert cfg.DATASET.NAME == "imagenet" or cfg.DATASET.NAME == "imagenet1" or cfg.DATASET.NAME == "imagenet100" or cfg.DATASET.NAME == "coco" or cfg.DATASET.NAME == "cityscape", f"Dataset should be ImageNet or its subset, but get {cfg.DATASET.NAME}"
